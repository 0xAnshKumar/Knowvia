...
export const CORPUS_DIR = path.join(BENCHMARKS_DIR, "corpus");
/** Override with EVAL_DATASET to run an older dataset version. */
export const DATASET_VERSION = process.env.EVAL_DATASET ?? "v1.1";
export const DATASET_DIR = path.join(BENCHMARKS_DIR, "datasets", DATASET_VERSION);
export const RUNS_DIR = path.join(BENCHMARKS_DIR, "runs");
export const PROMPTS_DIR = path.join(BENCHMARKS_DIR, "prompts");
