...
This harness evaluates the current Knowvia configuration against the real cloud
...
`https://eval.knowvia.local|eval-harness-v1`.
...
Every new run creates an immutable directory under `benchmarks/runs/` containing:
