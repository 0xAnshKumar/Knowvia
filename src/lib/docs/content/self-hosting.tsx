  ...
  pages: [
    {
      ...
      title: "Configuration",
      description:
        "Configure the external services needed to run Knowvia in your own environment.",
      sections: [
        {
          id: "services",
    ...
    },
    {
      ...
      description:
        "Run the frontend and backend locally and use the validation commands the project expects.",
      sections: [
        {
          id: "commands",
          title: "Commands",
      ...
      sections: [
        {
          ...
          body: (
            <p>
              The project includes a <code>vercel.json</code> configuration
