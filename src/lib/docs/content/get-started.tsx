  ...
  pages: [
    {
      ...
      title: "Knowvia docs",
      description:
        "Knowvia turns uploaded PDFs into searchable, cited conversations. This is how the product works and how to run it yourself.",
      quickFacts: [
      ...
      sections: [
        {
          id: "what-it-is",
          title: "What Knowvia is",
          body: (
            <>
              <p>
                Knowvia is a protected document workspace for uploading PDFs,
            ...
            <CardGrid
              items={[
                ...
                },
                {
                  ...
                  href: "/docs/using-knowvia/citations",
                },
              ]}
            />
          ),
...
npx convex dev`}</CodeBlock>
        ...
        },
        {
          ...
          body: (
            <CodeBlock title="Project checks">{`pnpm format:check
pnpm lint
pnpm typecheck
