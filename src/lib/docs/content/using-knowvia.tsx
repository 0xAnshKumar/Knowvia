...
export const usingKnowviaGroup: DocsGroup = {
  title: "Using Knowvia",
  pages: [
    {
    ...
    {
      slug: "using-knowvia/uploading-pdfs",
      group: "Using Knowvia",
      eyebrow: "Documents",
          ...
          body: (
            <>
              ...
              <Callout type="warning" title="Every PDF is OCR'd">
                Unlike many PDF tools, Knowvia does not read embedded text
    ...
    {
      slug: "using-knowvia/asking-questions",
      group: "Using Knowvia",
      eyebrow: "Chat",
      ...
      sections: [
        ...
        },
        {
          ...
          body: (
            <>
              <p>
                Knowvia is strongest when questions are specific enough for
        ...
        },
        {
          ...
          body: (
            <Callout type="note">
              If retrieval cannot find supporting evidence, Knowvia says so
    ...
    {
      slug: "using-knowvia/scanned-pdfs",
      group: "Using Knowvia",
      eyebrow: "OCR",
      title: "Scanned PDFs",
      description:
      ...
      sections: [
        {
          ...
          body: (
            <p>
              Knowvia sends every upload through Mistral OCR 4 — not only
