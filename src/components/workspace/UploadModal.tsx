...
export function UploadModal({
  ...
  const processFile = useCallback(
    async (file: File) => {
      ...
      captureEvent("document_upload_selected", getFileProperties(file));
      ...
      if (!looksLikePdf) {
        captureEvent("document_upload_rejected", {
      ...
      try {
        ...
        captureEvent("document_upload_validated", {
          ...getFileProperties(file),
        ...
        captureEvent("document_upload_completed", {
          ...getFileProperties(file),
