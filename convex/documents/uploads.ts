...
async function discardReservedUpload(
  ...
  await ctx.runMutation(internal.documents.records.deleteReservedDocument, {
    documentId,
...
export const completeDirectUpload = action({
  ...
  handler: async (ctx, args): Promise<Id<"documents">> => {
    ...
    const metadata = await ctx.runQuery(
      internal.documents.storage.getStorageMetadata,
    ...
    try {
      ...
      const completed = await ctx.runMutation(
        internal.documents.records.completeDirectUploadRecord,
        {
          documentId: args.documentId,
          ownerTokenIdentifier,
